...
def parse_args():
    ...
    parser.add_argument('--output', type=str, default="/home/jupyter-lpy/project/target_detection/CAD_VQA/gemini1.5pro/output/gemini1.5pro_result5/",
                        help='Path to save the results')
...
**返回要求**：
1.回答内容中用“====”分隔开分析推理过程以及最终答案
2.最终答案严格按照问题类型的回答要求进行回答，禁止添加标点及其他无关上下文（如：‘答案是’）
