...
if __name__ == "__main__":
    # 配置输入输出路径
    INPUT_JSON = "/home/jupyter-lpy/project/target_detection/CAD_VQA/allDate_vqa/claude3.7/merged.json"
    OUTPUT_JSON = "/home/jupyter-lpy/project/target_detection/CAD_VQA/allDate_vqa/claude3.7/删除推理后的评估数据.json"
